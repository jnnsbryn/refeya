...
include "../koneksi.php";
// Prepare the query
$query = "SELECT * FROM tbl_review INNER JOIN tbl_cafe ON tbl_review.id_cafe = tbl_cafe.id_cafe INNER JOIN tbl_user on tbl_review.id_user = tbl_user.id_user ORDER BY tbl_review.id_review DESC";
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item">
						<a class="nav-link text-light active" aria-current="page" href="#">User Review</a>
					</li>
				</ul>
	...
	<body>
		<div class="container">
			...
			<div class="card mb-3 border-black">
				<div class="row g-0">
					<div class="col-md-4">
						<img src="../photos/<?= $row['foto_cafe']; ?>" class="img-fluid rounded-start">
					</div>
					<div class="col-md-8">
						<div class="card-body">
							<h3 class="card-title"><?= $row['nama_cafe']; ?></h3>
							<p class="lead"><strong><?= $row['email_user']; ?></strong> berkata: "<?= $row['ulasan_cafe']; ?>" pada <?php $formatted_date = date('j F Y', strtotime($row['tanggal_update'])); echo $formatted_date; ?> dan memberi bintang <?= $row['rating_cafe']; ?>.</p>
						</div>
					</div>
